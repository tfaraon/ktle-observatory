...
"European interest in the lake was long bound up with the idea of an inland sea, which explorers of the early nineteenth century, Charles Sturt among them, set out to find {c:cohen2018}. When the lake did fill in 1974 the event prompted the founding of the Lake Eyre Yacht Club in the driest part of the continent {c:cohen2018}. A decade earlier the hard salt crust had served a very different purpose, when Donald Campbell drove Bluebird-Proteus CN7 across it on 17&nbsp;July 1964 to set a land speed record of 648.7&nbsp;km/h.",
]),
