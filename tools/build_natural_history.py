...
REFS = {
    ...
    "badman1991a": ("Badman 1991a", "Badman (1991a)",
        "Badman, F.J. (1991a) Introduction. In: Badman, F.J., Arnold, B.K. and Bell, S.L. (eds) <i>A Natural History of the Lake Eyre Region: A Visitor&rsquo;s Guide</i>, pp. 1&ndash;10. National Parks and Wildlife Service, Northern Consultative Committee, Port Augusta.",
        None),
    "sprigg1991": ("Sprigg 1991", "Sprigg (1991)",
        "Sprigg, R.C. (1991) Geological summary. In: Badman, F.J., Arnold, B.K. and Bell, S.L. (eds) <i>A Natural History of the Lake Eyre Region: A Visitor&rsquo;s Guide</i>, pp. 11&ndash;16. National Parks and Wildlife Service, Northern Consultative Committee, Port Augusta.",
        None),
    "badman1991d": ("Badman 1991d", "Badman (1991d)",
        "Badman, F.J. (1991d) Mound springs. In: Badman, F.J., Arnold, B.K. and Bell, S.L. (eds) <i>A Natural History of the Lake Eyre Region: A Visitor&rsquo;s Guide</i>, pp. 51&ndash;58. National Parks and Wildlife Service, Northern Consultative Committee, Port Augusta.",
        None),
    "arnold1991": ("Arnold 1991", "Arnold (1991)",
        "Arnold, B.K. (1991) National parks. In: Badman, F.J., Arnold, B.K. and Bell, S.L. (eds) <i>A Natural History of the Lake Eyre Region: A Visitor&rsquo;s Guide</i>, pp. 59&ndash;60. National Parks and Wildlife Service, Northern Consultative Committee, Port Augusta.",
        None),
    "litchfield1991": ("Litchfield 1991", "Litchfield (1991)",
        "Litchfield, L. (1991) Local history and lifestyle. In: Badman, F.J., Arnold, B.K. and Bell, S.L. (eds) <i>A Natural History of the Lake Eyre Region: A Visitor&rsquo;s Guide</i>, pp. 62&ndash;66. National Parks and Wildlife Service, Northern Consultative Committee, Port Augusta.",
        None),
}
...
"European exploration and settlement followed the line of the mound springs, the only permanent water over most of the country before dams and bores, and so did the Overland Telegraph Line, completed in 1872 with telegraph stations at the Strangways and Peake springs, the old Ghan railway, which reached Oodnadatta in 1891, and the southern part of the Oodnadatta Track {c:badman1991d,litchfield1991}. Elder and Stuckey introduced camels to the region in 1866, the year Lutheran missionaries arrived on Cooper Creek {c:litchfield1991}. {n:badman1991a} described three broad phases of seasons since settlement: wet years from the early 1860s to 1918, which encouraged an over-optimistic view of what the country could carry; an extremely dry phase from 1918 to 1949, when grazing and rabbits, then at their peak, caused the most severe degradation; and, after myxomatosis decimated the rabbits in the 1950s, a recovery that long-term residents judged, in 1991, to have left the country in better condition than twenty years earlier.",
...
"Protection of the lake began in 1967 with the Elliot Price Conservation Park on the Hunt Peninsula, named after Elliot Price of neighbouring Muloorina Station, and in 1985 the Lake Eyre National Park took in the whole bed of Lake Eyre North and part of the Tirari Desert west of the Birdsville Track {c:arnold1991}, the park that now bears the lake&rsquo;s dual name. The minor filling of 1989 had already drawn visitors to its shores in unprecedented numbers {c:arnold1991}.",
"{fig:marree-track|The Birdsville Track near Marree, the route that follows the line of the mound springs and that Cooper Creek floods cut from time to time.}",
]),
...
"Folding in the early Tertiary raised broad anticlinal domes, such as those of Moomba and Innamincka, which turned the main drainage lines aside: the Cooper and the Diamantina follow synclinal valleys around them before breaking through the arch that carries the Marree&ndash;Birdsville Track into the lake&rsquo;s depression, and the same structures trap much of the oil and gas of the deeper Cooper and Eromanga basins {c:sprigg1991}.",
...
"{fig:mound-spring|A mound spring of the Great Artesian Basin, on the arc that runs from Lake Callabonna to Dalhousie.}",
...
"The permanent springs form an arc from near Lake Callabonna, by the New South Wales border, through Marree, Coward Springs, William Creek and Oodnadatta to Dalhousie near the Northern Territory border, and the four groups around Hermit Hill alone hold at least 350 vents, more than 40% of the State&rsquo;s total {c:badman1991d}. The oldest are extinct: Hamilton Hill and Beresford Hill are relics of a time when the artesian water stood under much greater pressure, left some 40&nbsp;m above the surrounding plain as the land around them eroded away {c:badman1991d}. The bores drilled from the turn of the twentieth century reached a peak discharge of 2,055 megalitres a day in 1914, against a total recharge of the Great Artesian Basin then estimated at 3,500 megalitres a day, and as the pressure fell many springs weakened or stopped flowing {c:badman1991d}.",
"{fig:geology-cross-section|Cross-section through the lake and its basin, showing the depression, its sediment fill and the Great Artesian Basin beneath.}",
]),
...
"{fig:palaeo-lake-dieri|The extent of Lake Dieri, the deep lake that filled this basin during wetter phases, compared with the lake as it is today.}",
]),
...
"The Diamantina, which rises near Mount Isa and is joined in South Australia by the Georgina, flows into the State almost every year but often no further than Goyder Lagoon; it reaches the lake on average every two years, though often covering only a small part of its bed {c:badman1991a}. Cooper Creek, the largest of the rivers, seldom contributes much, because the lakes, swamps and broad floodplains of its lower course must fill first: its floods crossed the Birdsville Track ten times during the half century of the Kopperamanna and Killalpaninna missions, from 1866 to 1917, not once from 1918 to 1949, and nine times from 1951 to 1991, and between 1890 and 1991 they reached the lake eleven times, providing most of its water in 1950 {c:badman1991a}. From the south, the Frome rises near Mount Serle in the northern Flinders Ranges and passes Marree and Muloorina on its way to the lake, which it only occasionally reaches {c:badman1991a}.",
"The rhythm of filling follows the tropical Pacific: {n:kotwicki1991} linked the historical inflows to the El Ni&ntilde;o&ndash;Southern Oscillation, large fillings coinciding with strong La Ni&ntilde;a years, and {n:kotwicki1986} identified 1891, 1906, 1941, 1949&ndash;1951, 1953, 1955&ndash;1959 and 1963 as significant filling years. The greatest historical filling came in 1974, Australia&rsquo;s wettest year on record {c:ummenhofer2015}, when the lake reached depths of about 6&nbsp;m and held some 30&nbsp;km&sup3; {c:bye1978,kotwicki1986,bonython1989,devogel2004}. At that level Lake Eyre North was 5.7&nbsp;m deep at most and covered 8,430&nbsp;km&sup2;, Lake Eyre South 3.7&nbsp;m and 1,260&nbsp;km&sup2;, and of the water that entered between 1974 and 1976 some 38&nbsp;km&sup3; came down the Warburton, 2&nbsp;km&sup3; down the Cooper and 8&nbsp;km&sup3; from local rivers {c:badman1991a}. That year the Goyder Channel carried water from the northern lake to the southern; in 1984 and 1989 local rain filled Lake Eyre South instead, which overflowed northward and filled Lake Eyre North to 3.5&nbsp;m and 3.0&nbsp;m, the first time Europeans had seen the channel run from south to north {c:leycboat}. During the 1974 filling, water levels were recorded at five places in and between the lakes: a moderate wind of 30&nbsp;km an hour raised a wind tide of up to 0.6&nbsp;m on Lake Eyre North and 0.2&nbsp;m on Lake Eyre South, an effect that the shallow water and the flat bed make unusually large {c:kotwicki1986}. {n:badman1991a} gave a different account of 1984, attributing a minor filling to the western rivers alone, the Macumba, the Neales, Peake Creek and Douglas Creek, after up to 375&nbsp;mm of rain fell over their catchments in about a week.",
...
"{fig:goyder-channel|The Goyder Channel, the narrow link through which water passes between Lake Eyre North and Lake Eyre South, in one direction or the other depending on the flood.}",
]),
]
