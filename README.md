...
**Archive de 48 h.** Le BOM ne publie qu'une fenêtre glissante de 72 h.
...
archive continue de `weather.history_hours` même si le flux est tronqué
ou si une récupération échoue. Le vent des trois stations est tracé sous
